...
rmsp"""
b=a.split("\n\n")
print(sum([len(set(y)) for y in ["".join(x.splitlines()) for x in b]]))#part1
print(sum([sum([1 if len(z.splitlines())==y.count(w) else 0 for w in set(y)]) for y,z in [("".join(x.splitlines()),x) for x in b]]))#part2
