a="""dcbgefa cebd bfega eadbf db cdfaeb dba bfcgda egadcf aedcf | egadcfb eafcd db debc
...
#a=test
b = [[[z for z in y.split()] for y in x.split(' | ')] for x in a.splitlines()]
x1478 = [2,4,3,7]
print(sum([sum([1 for y in x[1] if len(y) in x1478]) for x in b]))
#print(b)